...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		do
		{
			...
			std::cout << "V�lj en av f�ljande: " << std::endl;
			std::cout << "\tg f�r GET." << std::endl;
			std::cout << "\to f�r POST." << std::endl;
			std::cout << "\tu f�r PUT." << std::endl;
			std::cout << "\td f�r DELETE." << std::endl;
			std::cout << "\tq f�r att avsluta." << std::endl;
			...
			if(input != 'q')
			{
				...
				std::cout << "V�ntar p� svar..." << std::endl;
